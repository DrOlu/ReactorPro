...
vi.mock('@/constants', () => ({
  ...
  AIDER_DESK_TASKS_DIR: '.reactorpro/tasks',
  AIDER_DESK_DIR: '.reactorpro',
  ...
  AIDER_DESK_AGENTS_DIR: '.reactorpro/agents',
  AIDER_DESK_TMP_DIR: '.reactorpro/tmp',
  AIDER_DESK_WATCH_FILES_LOCK: '.reactorpro/watch-files.lock',
  WORKTREE_BRANCH_PREFIX: 'reactorpro/task/',
...
describe('Task - git actions', () => {
  ...
  const worktreeBranch = 'reactorpro/task/worktree-branch';
