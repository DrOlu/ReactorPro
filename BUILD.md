...
```bash
npm run build --workspace @hyperspace/reactorpro-electron-app
```
...
1. **Build @hyperspace/reactorpro** → Produces the CLI `dist/` bundle (also rebuilds the UI assets it serves)
