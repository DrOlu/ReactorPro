export const remoteAccessMessages = {
  ...
  "remoteAccess.title": "Se connecter à ReactorPro à distance",
  "remoteAccess.subtitle": "Utilisez les adresses ci-dessous pour ouvrir ReactorPro depuis un autre appareil.",
