export const remoteAccessMessages = {
  ...
  "remoteAccess.title": "Conectar a ReactorPro de forma remota",
  "remoteAccess.subtitle": "Usa las direcciones de abajo para abrir ReactorPro desde otro dispositivo.",
