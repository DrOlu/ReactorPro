...
Create a file named `.reactorpro/commands/commit-message.md`:
...
Create a file named `.reactorpro/commands/squash.md`:
...
Create a file named `.reactorpro/commands/review/uncommitted.md`:
