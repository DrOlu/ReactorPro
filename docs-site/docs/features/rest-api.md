...
- **Request Body**:
  ...
  ```
  For the complete `SettingsData` structure, see [packages/common/src/types/common.ts](https://github.com/hyperspace/reactorpro/blob/main/packages/common/src/types/common.ts).
- **Response**: `200 OK` (returns updated settings)
