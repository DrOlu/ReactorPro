...
Every conversation in ReactorPro lives inside a **task**. Tasks persist all messages, context files, todos, and costs — close the app, come back tomorrow, and pick up exactly where you left off.
