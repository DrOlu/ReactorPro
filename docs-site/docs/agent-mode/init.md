...
You can find an example of the `AGENTS.md` file generated for ReactorPro itself [here](https://github.com/hyperspace/reactorpro/blob/main/.reactorpro/rules/AGENTS.md).
