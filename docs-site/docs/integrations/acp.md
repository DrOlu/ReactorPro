...
Run ReactorPro in headless mode via Docker. See the [Docker guide](../advanced/docker.md) for full setup instructions.
...
Install and run ReactorPro as a global npm package. See the [npm CLI guide](../advanced/npm-cli.md) for details.
...
- [Chat Modes](../core/chat-modes.md) — Learn about ReactorPro's chat modes
...
- [npm CLI](../advanced/npm-cli.md) — Running ReactorPro via npm
- [Docker](../advanced/docker.md) — Running ReactorPro in Docker
