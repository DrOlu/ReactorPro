...
The project is an Electron app with a multi-process architecture — see [AGENTS.md](https://github.com/hyperspace/reactorpro/blob/main/AGENTS.md) for a detailed map of the codebase before diving in.
