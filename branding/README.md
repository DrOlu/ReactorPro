<p align="center">
  <img src="docs/images/banner.webp" alt="ReactorPro" />
</p>
...
<p align="center">
  Built and maintained by <a href="https://reactorpro.ng">Hyperspace Technologies</a> · <a href="mailto:agent@reactorpro.ng">agent@reactorpro.ng</a>
</p>
...
ReactorPro is a **local-first** AI agent desktop client. It deeply integrates large language model reasoning with local system tools, so the AI can genuinely operate your file system, run commands, and manage scheduled tasks — while the Gateway enables remote access and collaboration.
...
Installers are automatically built, signed, and published by GitHub Actions — grab the latest version from [**GitHub Releases**](https://github.com/DrOlu/ReactorPro/releases/latest).
...
Download the DMG matching your chip from [Releases](https://github.com/DrOlu/ReactorPro/releases/latest), open it, and drag ReactorPro into Applications:

- Apple Silicon (M-series): `ReactorPro-<version>-macOS-aarch64.dmg`
- Intel: `ReactorPro-<version>-macOS-x64.dmg`

> The installer is signed and notarized by Apple — no manual security override is needed on first launch.

### Windows

Pick an installation method from [Releases](https://github.com/DrOlu/ReactorPro/releases/latest):

| Method | File | Best for |
|---|---|---|
| Setup wizard | `ReactorPro-<version>-Windows-x64-Setup.exe` | Most users |
| MSI package | `ReactorPro-<version>-Windows-x64.msi` | Enterprise distribution / silent install |
| Portable | `ReactorPro-<version>-Windows-x64-portable.zip` | No install — unzip and run |

### Linux

Choose by distribution from [Releases](https://github.com/DrOlu/ReactorPro/releases/latest):

| Format | Distributions | Install |
|---|---|---|
| AppImage | Any distribution | `chmod +x`, then run directly |
| DEB | Debian / Ubuntu family | `sudo dpkg -i ReactorPro-<version>-Linux-x86_64.deb` |
| RPM | Fedora / openSUSE family | `sudo rpm -i ReactorPro-<version>-Linux-x86_64.rpm` |
...
docker pull ghcr.io/drolu/liveagent-gateway:latest
...
docker run -d \
  ...
  ghcr.io/drolu/liveagent-gateway:latest
```
...
Thanks to everyone who has contributed to ReactorPro!

<a href="https://github.com/DrOlu/ReactorPro/graphs/contributors">
  <img src="https://raw.githubusercontent.com/DrOlu/ReactorPro/chart-assets/contributors.svg" alt="Contributors" />
</a>
...
<a href="https://www.star-history.com/?repos=DrOlu%2FReactorPro&type=date&legend=top-left">

 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/DrOlu/ReactorPro/chart-assets/star-history-dark.svg" />
   <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/DrOlu/ReactorPro/chart-assets/star-history-light.svg" />
   <img alt="Star History Chart" src="https://raw.githubusercontent.com/DrOlu/ReactorPro/chart-assets/star-history-light.svg" />
 </picture>
</a>
