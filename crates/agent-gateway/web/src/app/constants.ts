...
export const DEFAULT_BROWSER_TITLE = "ReactorPro Gateway";
export const NEW_CONVERSATION_BROWSER_TITLE = "ReactorPro";
export const SHARED_HISTORY_BROWSER_TITLE = "Shared Session";
