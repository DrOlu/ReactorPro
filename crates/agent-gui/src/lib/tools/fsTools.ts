...
export function createFsTools(params: {
  ...
  /** Conversation checkpoint context; when absent, Write/Edit/Delete do not capture pre-images (e.g. Cron scenarios). */
