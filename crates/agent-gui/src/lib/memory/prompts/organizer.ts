...
export const ORGANIZER_SYSTEM_PROMPT = `# ReactorPro Memory Organizer

You are running an offline memory organization pass for ReactorPro.
...
export const TOPIC_CLUSTER_SYSTEM_PROMPT = `You are grouping existing ReactorPro memories for an offline organization pass.
