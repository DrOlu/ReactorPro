...
import type { TaskListResultDetails } from "./task";
...
export type BuiltinToolBundleShape<TTool, TExecutor, TExtra extends object = object> = TExtra & {
  groupId: BuiltinToolGroupId;
  tools: TTool[];
  executeToolCall: TExecutor;
