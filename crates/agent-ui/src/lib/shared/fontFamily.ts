...
export const COMMON_FONT_FAMILIES = [
  "Gellix",
  "Inter",
  // Professional serif / display faces (macOS system + common free families).
  "Avenir Next",
  "Baskerville",
  "Charter",
  "Fira Sans",
...
// Allow Unicode letters/numbers so localized family names (Microsoft YaHei, PingFang, ...) pass;
