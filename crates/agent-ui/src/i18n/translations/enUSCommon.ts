export const EN_US_COMMON_TRANSLATIONS = {
  ...
  "chat.searchConversationsPlaceholder": "Search conversations",
  "chat.searchConversationsDescription": "Search conversation titles and message history.",
  "chat.conversationSearchResults": "Search results",
  "chat.pinnedConversations": "Pinned conversations",
  "chat.noConversationSearchResults": "No matching conversations",
  "chat.conversationSearchFailed": "Couldn't search conversation history. Try again.",
  "chat.retryConversationSearch": "Retry",
  ...
  "chat.workspaceMountDropNoProject":
    "Select a workspace before dropping folders to mount them as workspace directories",
  "chat.workspaceMountDropSuccess":
    "Mounted {count} folder(s) as read-only workspace directories (adjust in workspace settings)",
  ...
  "chat.workspaceMountDropSkippedOverlap":
    "Skipped {count} folder(s) overlapping existing workspace directories",
  "chat.workspaceMountDropFailed": "Failed to mount workspace directories",
  ...
  "chat.workspaceGroupDeleteConfirmDescription":
    "Workspaces in the group move back to ungrouped; the workspaces themselves are not deleted.",
  ...
  "chat.projectPromptTitle": "Workspace prompt",
  ...
  "chat.projectPromptStrategyHint":
    "Choose how this workspace prompt combines with the active global template.",
  "chat.projectPromptAppend": "Append",
  "chat.projectPromptAppendHint":
    "Apply the active global prompt first, then add this workspace's instructions.",
  "chat.projectPromptReplace": "Replace",
  "chat.projectPromptReplaceHint":
    "Use only the workspace prompt here and leave out the global prompt.",
  "chat.projectPromptContentHint": "Leave empty to use global prompts only for this workspace.",
  "chat.projectPromptPlaceholder":
    "Describe the context, constraints, and working style specific to this workspace...",
  "chat.workspaceSettingsTitle": "Workspace settings",
  "chat.workspaceSettingsNavigation": "Workspace settings navigation",
  ...
  "chat.workspaceSettingsProjectName": "Workspace name",
  "chat.workspaceSettingsProjectNameRequired": "Workspace name is required.",
  "chat.workspaceSettingsProjectType": "Workspace type",
  "chat.workspaceSettingsKindManaged": "Managed workspace",
  ...
  "chat.workspaceSettingsDirectoryDuplicate":
    "This directory has already been added to the workspace.",
  "chat.workspaceSettingsResourcesDescription":
    "Control which Skills and MCP services this workspace exposes to the Agent.",
  ...
  "chat.workspacePathDrop.crossProject": "This path belongs to another workspace",
  ...
  "sidebar.continueLoadingHistory": "Load more conversations",
  "chat.pinnedSection": "Pinned",
  "chat.workspaceHistoryToggle": "Expand/collapse conversations",
  "chat.workspaceHistoryRetry": "Retry loading conversations",
